...
var headerContainerMenu = document.querySelector('.header__container-menu');
...
exports.initHeaderSwiper = void 0;
var _swiper = _interopRequireDefault(require("../js/vendor/swiper.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var headerSwiper = document.querySelector('.header__swiper');
var initHeaderSwiper = exports.initHeaderSwiper = function initHeaderSwiper() {
  if (headerSwiper) {
    (function () {
      return new _swiper.default('.header__swiper', {
...
},{"../js/vendor/swiper.js":12}],5:[function(require,module,exports){
"use strict";
...
},{"./accordions.js":2}],6:[function(require,module,exports){
"use strict";

var _initAccordion = require("./init-accordion");
var _accordionsButton = require("./accordions-button");
var _specialistSwiper = require("./specialist-swiper");
var _modalGallery = require("./modal-gallery");
var _burgerMenu = require("./burger-menu");
var _sliderWithTextSwiper = require("./slider-with-text-swiper");
var _sliderWithoutTextSwiper = require("./slider-without-text-swiper");
var _menuScroll = require("./menu-scroll");
var _headerSwiper = require("./header-swiper");
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  (0, _headerSwiper.initHeaderSwiper)();
  ...
  (0, _specialistSwiper.initSpecialistSwiper)();
  (0, _burgerMenu.initMenu)();
  (0, _sliderWithTextSwiper.initSliderWithTextSwiper)();
  (0, _sliderWithoutTextSwiper.initSliderWithoutTextSwiper)();
  (0, _menuScroll.menuScroll)();
  // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  // в load следует добавить скрипты, не участвующие в работе первого экрана
  window.addEventListener('load', function () {
    (0, _initAccordion.initAccordions)();
    (0, _modalGallery.initModalGallery)();
  });
});

},{"./accordions-button":1,"./burger-menu":3,"./header-swiper":4,"./init-accordion":5,"./menu-scroll":7,"./modal-gallery":8,"./slider-with-text-swiper":9,"./slider-without-text-swiper":10,"./specialist-swiper":11}],7:[function(require,module,exports){
"use strict";
...
var menuServices = document.querySelector('.menu__link-services');
var menuContacts = document.querySelector('.menu__link-contacts');
var footerMenuServices = document.querySelector('.footer__link-services');
var footerMenuContacts = document.querySelector('.footer__link-contacts');
var menuScroll = exports.menuScroll = function menuScroll() {
...
exports.initModalGallery = void 0;
var gallery = document.getElementById('gallery');
var modal = document.getElementById('myModal');
var modalImg = document.getElementById('modalImg');
var closeBtn = document.querySelector('.modal__close');
var initModalGallery = exports.initModalGallery = function initModalGallery() {
  gallery.addEventListener('click', function (event) {
    var target = event.target;
    if (target.tagName === 'IMG') {
      var fullSizeSrc = target.getAttribute('data-fullsize');
      if (fullSizeSrc) {
...
exports.initSliderWithTextSwiper = void 0;
var _swiper = _interopRequireDefault(require("../js/vendor/swiper.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var sliderWithTextSwiper = document.querySelector('.slider-with-text__swiper');
var initSliderWithTextSwiper = exports.initSliderWithTextSwiper = function initSliderWithTextSwiper() {
  if (sliderWithTextSwiper) {
    (function () {
      return new _swiper.default('.slider-with-text__swiper', {
        direction: 'horizontal',
        loop: true,
        navigation: {
...
},{"../js/vendor/swiper.js":12}],10:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initSliderWithoutTextSwiper = void 0;
var _swiper = _interopRequireDefault(require("../js/vendor/swiper.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var sliderWithoutTextSwiper = document.querySelector('.slider-without-text__swiper');
var initSliderWithoutTextSwiper = exports.initSliderWithoutTextSwiper = function initSliderWithoutTextSwiper() {
  if (sliderWithoutTextSwiper) {
    (function () {
      return new _swiper.default('.slider-without-text__swiper', {
        direction: 'horizontal',
        loop: true,
        navigation: {
          nextEl: '.swiper-button-next',
...
},{"../js/vendor/swiper.js":12}],11:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initSpecialistSwiper = void 0;
var _swiper = _interopRequireDefault(require("../js/vendor/swiper.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var specialistSwiper = document.querySelector('.specialist__swiper');
var initSpecialistSwiper = exports.initSpecialistSwiper = function initSpecialistSwiper() {
  if (specialistSwiper) {
    (function () {
      return new _swiper.default('.specialist__swiper', {
        direction: 'horizontal',
        loop: true,
        navigation: {
          nextEl: '.swiper-button-next',
...
},{"../js/vendor/swiper.js":12}],12:[function(require,module,exports){
